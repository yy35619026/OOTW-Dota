    ...
    public JButton[] getButton(String image) {
        ...
        for (int i = 0; i < Originalx.length; i++) {
            ...
            if(image.equals("./res/Tower/tower1.png")){
                imageoptionButton.setBounds((Originalx[i] - 65 + 0 * 67), (Originaly[i] - 80), 45, 80);
            }else if(image.equals("./res/Tower/tower2.png")){
                imageoptionButton.setBounds((Originalx[i] - 65 + 1 * 67), (Originaly[i] - 80), 45, 80);
            } else if(image.equals("./res/Tower/tower3.png")){
                imageoptionButton.setBounds((Originalx[i] - 65 + 2 * 67), (Originaly[i] - 80), 45, 80);
            }
